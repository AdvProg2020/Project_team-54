...
//        mediaPlayer.play();
        ...
        Image shoeImage = new Image("images/shoe.png");
        Image hatImage = new Image("images/hat.jpg");
        Image iphoneImage = new Image("images/hat.jpg");
        Image waterMelonImage = new Image("images/watermelon.jpg");
        Image handsfreeImage = new Image("images/handsfree.png");
        ...
        Good iphone = new Good(4, "iphone 11 pro max", "Iphone", 25000000, Account.getAccountWithUsername("rezas") , true, fruits, "the next generation of iphones");
