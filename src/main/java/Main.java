...
//        mediaPlayer.play();
        ...
        new Seller("reza", "reza" , "soumi", "rez@gmail.com", "2", "rez","sharif", Role.seller);
        ...
        Good banana = new Good(1, "banana", "digikala", 4000, (Seller) Account.getAccountWithUsername("reza") , true, fruits, "very good for health");
        banana.setImage(bananaImage);
        Good apple = new Good(2, "apple", "digikala", 1000, (Seller) Account.getAccountWithUsername("reza") , true, fruits, "very good for breakfast");
        apple.setImage(appleImage);
        Good waterMelon = new Good(3, "water melon", "digikala", 15000, (Seller) Account.getAccountWithUsername("reza") , true, fruits, "very juicy and sweet");
        waterMelon.setImage(waterMelonImage);
        Good iphone = new Good(4, "iphone 11 pro max", "Iphone", 25000000, (Seller) Account.getAccountWithUsername("reza") , true, phones, "the next generation of iphones");
...
//        Good galaxy = new Good(5, "Galaxy S20 ultra", "Samsung", 15000000, (Seller) Account.getAccountWithUsername("rezas") , true, fruits, "a brand new galaxy phone");
        Good handsfree = new Good(6, "handsfree", "AKG", 15000, (Seller) Account.getAccountWithUsername("reza") , true, digital, "better experience");
        handsfree.setImage(handsfreeImage);
        Good peach = new Good(7, "peach", "tarebar", 10000, (Seller) Account.getAccountWithUsername("reza") , true, fruits, "peachy peachy!");
